            ...
            <section className="price__table">
                <div className="price__table-content">
                    ...
                    <div className="price__table--text">
                        ...
                        <a className="price__table--link" href="#"><span>Shop Now</span></a>
                    </div>
                    </div>
                </div>	
                <div className="price__table-content">
                ...
                <div className="product__container">
                    <div className="product__wrapper">
                            <div className="product__image--wrapper">
                                <div className="product__content">
                                    ...
                                    <div className="info__products">
                                        ...
                                        <div className="price__box">																										
                                            <span className="special__price">$200.60</span>
                                            <span className="old__price">$227.96</span>
                                        </div>
                                ...
                                {/* <a className="arrows" href="#"><FaArrowsAlt/></a>*/}                      
                            </div>
                        </div>
                        <div className="product__wrapper">
                            <div className="product__image--wrapper">
